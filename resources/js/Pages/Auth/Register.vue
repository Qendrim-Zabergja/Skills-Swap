<template>
            ...
            <div v-if="errors.general" class="text-sm text-red-600 mb-2">
              ...
              <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div class="mb-4" class="mb-4">
                  ...
                  <input id="first_name" type="text" v-model="form.first_name" :class="{
                  ...
                  }" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2" :disabled="isLoading"
                ...
                <div class="mb-4" class="mb-4">
                  ...
                  <input id="last_name" type="text" v-model="form.last_name" :class="{
              ...
              <div class="mb-4">
                ...
                <input id="email" type="email" v-model="form.email" :class="{
              ...
              <div class="mb-4">
                ...
                <input id="password" type="password" v-model="form.password" :class="{
              ...
              <div class="mb-6">
                <div class="flex items-start">
                  <div class="flex items-center h-5">
                    <input id="terms" type="checkbox" v-model="form.terms" :class="{
              ...
              <button type="submit"
                ...
                focus:ring-2 focus:ring-offset-2 focus:ring-black disabled:opacity-50 flex justify-center items-center"
                :disabled="isLoading">
                <svg v-if="isLoading" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white"
                  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
  ...
  <div v-if="showTermsModal" class="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-xl max-w-lg w-full shadow-lg max-h-[80vh] overflow-y-auto">
      ...
      <p class="text-sm text-gray-700 mb-3">
        Welcome to SkillSwap! By accessing or using our platform, you agree to comply with and be bound by these Terms
        of Service. Please read them carefully.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        1. <strong>Account Responsibility:</strong> You are responsible for maintaining the confidentiality of your
        account information and for all activities that occur under your account.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        2. <strong>User Conduct:</strong> You agree not to use SkillSwap for any unlawful or prohibited activities.
        Respect other users and refrain from harassment, discrimination, or harmful behavior.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        3. <strong>Content Ownership:</strong> You retain ownership of your content, but grant SkillSwap a license to
        display and distribute it within the platform.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        4. <strong>Modifications:</strong> We may update or modify these Terms from time to time. Continued use of the
      ...
      <div class="mt-6 text-right">
        <button @click="showTermsModal = false" class="px-4 py-2 bg-black text-white rounded hover:bg-gray-800">
          Close
        </button>
      </div>
    </div>
  ...
  <div v-if="showPrivacyModal" class="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-xl max-w-lg w-full shadow-lg max-h-[80vh] overflow-y-auto">
      ...
      <p class="text-sm text-gray-700 mb-3">
        1. <strong>Information Collection:</strong> We collect personal data that you provide during registration and
        use of our services, including your name, email, and profile details.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        2. <strong>Use of Data:</strong> Your data is used to provide and improve our services, communicate updates, and
        personalize your experience.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        3. <strong>Data Sharing:</strong> We do not sell your information to third parties. We may share data with
        trusted service providers under strict confidentiality agreements.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        4. <strong>Security:</strong> We implement appropriate technical and organizational measures to safeguard your
        information.
      </p>
      <p class="text-sm text-gray-700 mb-3">
        5. <strong>Your Rights:</strong> You can access, correct, or request deletion of your personal data by
      ...
      <div class="mt-6 text-right">
        <button @click="showPrivacyModal = false" class="px-4 py-2 bg-black text-white rounded hover:bg-gray-800">
          Close
        </button>
      </div>
    </div>
